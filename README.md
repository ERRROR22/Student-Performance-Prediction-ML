...
Results
The models provide a Classification Report including precision, recall, and F1-score for each performance category. Based on the code, the Random Forest and Logistic Regression models typically offer the most robust performance for this dataset. 
